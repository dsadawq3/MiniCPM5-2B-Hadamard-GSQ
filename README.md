...
[![Size](https://img.shields.io/badge/Memory-2.22%20GB%20(-52.7%25)-purple.svg)](#-empirical-scorecard)
[![Context](https://img.shields.io/badge/Context-128K%20Tokens-green.svg)](#-128k-context--kv-bss-associative-recall)

<p align="center">
  <b>2.40B Parameters Compressed to 2.22 GB</b> • <b>128K Context Window</b> • <b>Zero Attention Drift (Pure BF16 Shield)</b>
</p>
...
| :--- | :---: | :---: | :--- |
| **Total Weight Footprint** | **4.69 GB** (5,033,557,096 B) | **2.22 GB** (2,382,190,440 B) | **-2.47 GB (-52.7% Physical RAM Saved)** |
| **Compression Ratio** | 1.000× (Baseline) | **2.11×** | **Sub-3GB RAM execution on Mobile/Edge** |
